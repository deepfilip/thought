...
$(package)_patches=rename-bn_init-to-bn_make.patch blake2-align-state-structs.patch relic-cmake-cflags-preservation-r3.patch exclude-runtest-from-all.patch relic-label-target-name.patch
...
define $(package)_set_vars
  ...
  $(package)_config_opts+= -DLABEL=chiabls
